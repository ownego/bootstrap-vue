...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('mitt')) :
  typeof define === 'function' && define.amd ? define(['vue', 'mitt'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.bootstrapVueIcons = factory(global.Vue, global.mitt));
}(this, (function (OurVue, mitt) { 'use strict';
  ...
  var OurVue__namespace = /*#__PURE__*/_interopNamespace(OurVue);
  ...
  var LISTENER_KEY_PREFIX = 'on';
  var NATIV_LISTENER_KEY_PREFIX = 'nativeOn';

  var applyFunctionalRenderArguments = function applyFunctionalRenderArguments(render) {
    return function () {
      var attrs = this.$attrs,
          props = this.$props,
          scopedSlots = this.$slots,
          parent = this.$parent;
      var children = normalizeSlot(SLOT_NAME_DEFAULT, {}, scopedSlots);
  ...
  var normalizeDefineComponentData = function normalizeDefineComponentData(data) {

    var functional = data.functional,
        unmounted = data.destroyed,
        beforeUnmount = data.beforeDestroy,
        _render = data.render,
        otherData = _objectWithoutProperties(data, ["functional", "destroyed", "beforeDestroy", "render"]);

    return _objectSpread2(_objectSpread2({}, otherData), {}, {
      unmounted: unmounted,
  ...
  var normalizeVNodeData = function normalizeVNodeData(data) {
    ...
    var staticClass = data.staticClass,
        ...
        _data$domProps = data.domProps,
        domProps = _data$domProps === void 0 ? {} : _data$domProps,
        _data$nativeOn = data.nativeOn,
        nativeOn = _data$nativeOn === void 0 ? {} : _data$nativeOn,
        _data$on = data.on,
        on = _data$on === void 0 ? {} : _data$on,
        otherData = _objectWithoutProperties(data, ["staticClass", "class", "staticStyle", "style", "attrs", "props", "domProps", "nativeOn", "on"]);

    return _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, otherData), attrs), domProps), props), keys(nativeOn).reduce(function (result, key) {
      return _objectSpread2(_objectSpread2({}, result), {}, _defineProperty({}, NATIV_LISTENER_KEY_PREFIX + upperFirst(key), nativeOn[key]));
    }, {})), keys(on).reduce(function (result, key) {
      return _objectSpread2(_objectSpread2({}, result), {}, _defineProperty({}, LISTENER_KEY_PREFIX + upperFirst(key), on[key]));
    }, {})), staticClass || classes ? {
      class: [staticClass, classes]
    } : {}), staticStyle || style ? {
      style: [staticStyle, style]
    } : {});
  };

  var normalizeVNodeDirectives = function normalizeVNodeDirectives(directives) {
    return  directives.map(function (_ref) {
      var name = _ref.name,
          value = _ref.value,
          arg = _ref.arg,
          modifiers = _ref.modifiers;
      return [name, value, arg, modifiers];
    });
  };


  var defineComponent = function defineComponent(data) {
    return OurVue.defineComponent(normalizeDefineComponentData(data));
  };
  ...
  var h = function h() {
    ...
    if (isPlainObject(data)) {
      var _data = data,
          _data$directives = _data.directives,
          directives = _data$directives === void 0 ? [] : _data$directives,
          otherData = _objectWithoutProperties(_data, ["directives"]);

      data = normalizeVNodeData(otherData);
      normalizedDirectives = normalizeVNodeDirectives(directives);
    }

    var vNode = OurVue.h.apply(void 0, _toConsumableArray([tag, data, children].slice(0, args.length)));

    return normalizedDirectives.length > 0 ? OurVue.withDirectives(vNode, normalizedDirectives) : vNode;
  };

  var ROOT_EVENT_EMITTER_KEY = '$bvEvents';
  ...
  var setConfig = function setConfig(app) {
    var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    // Get/Create the current config
    var bvConfig = ( app.config.globalProperties[PROP_NAME]) || new BvConfig(); // Apply the config values

    bvConfig.setConfig(config); // Re-assign the config
  ...
  var createEmitter = function createEmitter() {
  ...
  var checkMultipleVue = function () {
    ...
    return function (Vue) {
      /* istanbul ignore next */
      if ( !checkMultipleVueWarned && OurVue__namespace !== Vue && !isJSDOM) {
  ...
  var registerEmitter = function registerEmitter(app, key) {
  ...
  var registerComponent = function registerComponent(app, name, component) {
  ...
  var registerDirective = function registerDirective(app, name, directive) {
  ...
  var registerPlugins = function registerPlugins(app) {
  ...
  var installFactory = function installFactory() {
    ...
    var globalConfig = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  ...
  var BVIconBase = /*#__PURE__*/defineComponent({
    name: NAME_ICON_BASE,
    functional: true,
  ...
  var BIcon = /*#__PURE__*/defineComponent({
    name: NAME_ICON,
    functional: true,
  ...
  var BIconstack = /*#__PURE__*/defineComponent({
    name: NAME_ICONSTACK,
    functional: true,
