...
import { defineComponent as defineComponent$1, h as h$1, withDirectives } from 'vue';
...
var defineComponent = function defineComponent(data) {
  return defineComponent$1(normalizeDefineComponentData(data));
};
...
var h = function h() {
  ...
  var vNode = h$1.apply(void 0, _toConsumableArray([tag, data, children].slice(0, args.length)));
