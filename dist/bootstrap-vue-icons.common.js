...
var defineComponent = function defineComponent(data) {
  return Vue.defineComponent(normalizeDefineComponentData(data));
};
...
var h = function h() {
  ...
  var vNode = Vue.h.apply(void 0, _toConsumableArray([tag, data, children].slice(0, args.length)));

  return normalizedDirectives.length > 0 ? Vue.withDirectives(vNode, normalizedDirectives) : vNode;
};
...
var checkMultipleVue = function () {
  ...
  return function (Vue) {
    /* istanbul ignore next */
    if ( !checkMultipleVueWarned && Vue__namespace !== Vue && !isJSDOM) {
